 ...
 * generated in the com.panda.WSConsumer package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestWebService_QNAME = new QName("http://externalService.app.panda.com/", "testWebService");
    private final static QName _TestWebServiceResponse_QNAME = new QName("http://externalService.app.panda.com/", "testWebServiceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.panda.WSConsumer
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://externalService.app.panda.com/", name = "testWebService")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://externalService.app.panda.com/", name = "testWebServiceResponse")
