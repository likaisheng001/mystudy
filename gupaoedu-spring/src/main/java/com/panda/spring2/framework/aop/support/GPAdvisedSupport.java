package com.panda.spring2.framework.aop.support;/**
 * Created by My on 2019-12-17.
 */

import com.panda.spring2.framework.aop.aspect.GPAfterReturningAdviceInterceptor;
import com.panda.spring2.framework.aop.aspect.GPAfterThrowingAdviceInterceptor;
import com.panda.spring2.framework.aop.aspect.GPMethodBeforeAdviceInterceptor;
 ...
 * @Author: Likaisheng
 * @Description:
 * @Date: Created in 14:17:35 2019-12-17
 * @Modified By:
 */
            ...
            for (Method m : this.targetClass.getMethods()) {
                ...
                if (matcher.matches()) {
                    ...
                    if (!(null == config.getAspectAfterThrow() || "".equals(config.getAspectAfterThrow()))) {
                        //创建一个Advice
                        GPAfterThrowingAdviceInterceptor throwingAdvice = new GPAfterThrowingAdviceInterceptor(aspectMethods.get(config.getAspectAfterThrow()),aspectClass.newInstance());
