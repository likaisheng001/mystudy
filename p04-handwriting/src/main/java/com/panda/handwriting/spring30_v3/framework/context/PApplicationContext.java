package com.panda.handwriting.spring30_v3.framework.context;/**
...
import com.panda.handwriting.spring30_v3.framework.annotation.PService;
import com.panda.handwriting.spring30_v3.framework.aop.PDefaultAopProxyFactory;
import com.panda.handwriting.spring30_v3.framework.aop.PJdkDynamicAopProxy;
...
import com.panda.handwriting.spring30_v3.framework.beans.PBeanWrapper;
import com.panda.handwriting.spring30_v3.framework.beans.config.PBeanDefinition;
import com.panda.handwriting.spring30_v3.framework.beans.support.PBeanDefinitionReader;
import com.panda.handwriting.spring30_v3.framework.beans.support.PDefaultListableBeanFactory;
 ...
 * @Modified By:
 */
public class PApplicationContext implements PBeanFactory {

    private PBeanDefinitionReader reader;
    private PDefaultListableBeanFactory registry = new PDefaultListableBeanFactory();
    private Map<String, PBeanWrapper> factoryBeanInstanceCache = new HashMap<String, PBeanWrapper>();
    private Map<String,Object> factoryBeanObjectCache = new HashMap<String,Object>();
    private PDefaultAopProxyFactory proxyFactory = new PDefaultAopProxyFactory();
    ...
    public PApplicationContext(String... configLocations){
        try {
            ...
            registry.doRegistBeanDefinition(beanDefinitionList);
            //4. 自动注入
            doAutowrited();
        }catch (Exception e){
            e.printStackTrace();
    ...
    private void doAutowrited() {
        ...
        for (Map.Entry<String, PBeanDefinition> beanDefinitionEntry : registry.beanDefinitionMap.entrySet()){
    ...
    public Object getBean(String beanName){
        ...
        PBeanDefinition beanDefinition = registry.beanDefinitionMap.get(beanName);
        //2. 反射实例化newInstance();
